            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="index.php"><i class="fa fa-address-card-o"></i> My Worker Req</a></li>
                  <li><a href="../jobs.php"><i class="fa fa-list-ul"></i> Workers</a></li>
