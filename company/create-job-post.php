...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>SerVale</b> </span>
    </a>
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="edit-company.php"><i class="fa fa-tv"></i> Myself</a></li>
                  <li class="active"><a href="create-job-post.php"><i class="fa fa-file-o"></i> Create SerVice Post</a></li>
                  <li><a href="my-job-post.php"><i class="fa fa-file-o"></i> My SerVice Post</a></li>
                  <li><a href="job-applications.php"><i class="fa fa-file-o"></i> Customer</a></li>
                  <li><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li>
                  <li><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
                  <li><a href="resume-database.php"><i class="fa fa-user"></i> Client Database</a></li>
            ...
            <div class="row">
              <form method="post" action="addpost.php">
                ...
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="qualification" name="qualification" placeholder="Skills" required="">
                  </div>
                  <div class="form-group">
...
<strong>Copyright &copy; 2023 <a href="jonsnow.netai.net">SerVale</a>.</strong> All rights   reserved.
    </div>
  </footer>
