      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div>
              <a href="apply.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-success btn-flat margin-top-50">Hire</a>
            </div>
            <?php } ?>
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <hr>
                <div class="row">
                  <div class="col-md-4"><a href=""><i class="fa fa-address-card-o"></i> Hire</a></div>
